package com.buscaio.buscaio.controller;
...
import com.buscaio.buscaio.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	public ResponseEntity<List<CategoriaModel>> GetByTema(@PathVariable String tema){ 
